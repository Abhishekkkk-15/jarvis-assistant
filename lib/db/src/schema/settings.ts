...
export const settingsTable = sqliteTable("settings", {
  ...
  startupNotificationEnabled: integer("startup_notification_enabled", { mode: "boolean" }).notNull().default(false),
  startupNotificationPrompt: text("startup_notification_prompt").notNull().default("The system has just booted. Please provide a brief morning greeting and summarize the current weather or time."),
